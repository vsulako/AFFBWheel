...
- При использовании мощного двигателя возможна ситуация перегрузки БП. Во избежание повреждений можно использовать что-то для ограничения тока через двигатель, например - понижающий DC-DC преобразователь с возможностью ограничения по току в подходящих пределах (10-20A): ![](images/dcdc.jpg)
