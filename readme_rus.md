...
12битный, достаточно быстрый, относительно недорогой. Пожалуй, лучший из всех.
...
Пример: ось руля и датчика связаны ременной передачей, диаметр шкива на руле - 200 единиц, на датчике - 30, на один оборот руля ось датчика совершает 10 оборотов, тогда для коррекции показаний необходимо применить коэффициент 20:200, т.е. 1:10 и конфигурация будет такой: 
