...
- кнопка 25 будет считаться нажатой, если на A11 значение АЦП будет в пределах 32±20, т.е. от 12 до 52.
- кнопка 26 будет считаться нажатой, если на A11 значение АЦП будет в пределах 96±20, т.е. от 76 до 116.
...
![Wiring diagram](images/analog_shifter.png)
